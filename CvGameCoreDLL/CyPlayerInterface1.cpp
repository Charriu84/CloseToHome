...
// BUG - end
		...
		//Charriu TrackingDomesticProtectiveBonus
		.def("getBetterTrackingDomesticProtectiveBonus", &CyPlayer::getBetterTrackingDomesticProtectiveBonus, "int ()")
		...
		.def("getTechTracking", &CyPlayer::getTechTracking, "std::wstring ()")
