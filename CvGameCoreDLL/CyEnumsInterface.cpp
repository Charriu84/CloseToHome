...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_EXTRA_PALACE_COMMERCE", WIDGET_HELP_EXTRA_PALACE_COMMERCE)
		...
		.value("WIDGET_HELP_DOMAIN_ANIMAL_COMBATS", WIDGET_HELP_DOMAIN_ANIMAL_COMBATS)
...
// BUG - Leaderhead Relations - end
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_INFLATION_TIED_TO_TECH", GAMEOPTION_INFLATION_TIED_TO_TECH)
		...
		.value("GAMEOPTION_QUESTS_FOR_EVERYBODY", GAMEOPTION_QUESTS_FOR_EVERYBODY)
		.value("GAMEOPTION_DETERMINISTIC_BARB", GAMEOPTION_DETERMINISTIC_BARBS)
...
// BUG - end
	...
	python::enum_<GameMessageTypes>("GameMessageTypes")
		...
		.value("GAMEMESSAGE_TURN_INCOMPLETE", GAMEMESSAGE_TURN_INCOMPLETE)
		;
